        ...
        if (event.getRawSlot() == -999) {
            ...
            if (title.contains("슬롯머신")) {
                ...
                if (type == Material.RECORD_3) {
                    if (Main.instance.econ.getBalance(p) >= Main.coinneed) {
                        Hashmap.addplayer(p, Main.coinneed);
                        Main.instance.econ.withdrawPlayer(p, Main.coinneed);
                ...
                if (event.getCurrentItem() != null)
                    if (event.getCurrentItem().getType() == Material.CHEST)
                        ...
                        if (p.getOpenInventory().getItem(13).getType() == Material.DIAMOND_BLOCK){
                            ...
                            Main.instance.econ.depositPlayer(target, resultval);
                        ...
                        if (p.getOpenInventory().getItem(13).getType() == Material.DIAMOND_BLOCK) {
                            ...
                            if (event.getClick() == ClickType.LEFT){
                                ...
                                if (Hashmap.indian.get(p.getUniqueId().toString()) != null){
                                    target = Bukkit.getPlayer(UUID.fromString(Hashmap.indian.get(p.getUniqueId().toString())));
                                    if (Hashmap.getbetmoney(p) + (int)((double)Hashmap.indiannmax.get(p.getUniqueId().toString())/10) >= Hashmap.indiannmax.get(p.getUniqueId().toString())){
                                        Main.instance.econ.withdrawPlayer(p,Hashmap.indiannmax.get(p.getUniqueId().toString()) - Hashmap.getbetmoney(p));
                                        Hashmap.slotuse.put(p, Hashmap.getbetmoney(p) + Hashmap.indiannmax.get(p.getUniqueId().toString()) - Hashmap.getbetmoney(p));
                                        ItemStack stack = new ItemStack(Material.WOOD_BUTTON);
                                        ItemMeta meta = stack.getItemMeta();
                                        meta.setDisplayName(Command.st + ChatColor.RED + "베팅(Bet)");
                                        List lore = new ArrayList();
                                        lore.add(" ");
                                        lore.add(ChatColor.DARK_GRAY + " -  " + ChatColor.RED + "현재 당신의 베팅액 " + ChatColor.GRAY + ": " + ChatColor.GOLD + Hashmap.getbetmoney(p) + "원");
                                        lore.add(ChatColor.DARK_GRAY + " -  " + ChatColor.AQUA + "현재 상대의 베팅액 " + ChatColor.GRAY + ": " + ChatColor.GOLD + Hashmap.getbetmoney(target) + "원");
                                        lore.add(ChatColor.DARK_GRAY + " -  " + ChatColor.RED + "좌클릭시 " + ChatColor.GOLD + (int)((double)Hashmap.indiannmax.get(p.getUniqueId().toString())/10) +  ChatColor.WHITE + "원을 베팅합니다.");
                                        lore.add(ChatColor.DARK_GRAY + " -  " + ChatColor.GREEN + "우클릭시 베팅을 종료합니다. 단 상대방의 베팅액보다 크거나 같아야 합니다.");
                                        lore.add(" ");
                                        meta.setLore(lore);
                                        stack.setItemMeta(meta);
                                        ItemStack redstone = new ItemStack(Material.REDSTONE_BLOCK);
                                        ItemMeta stonemeta = redstone.getItemMeta();
                                        stonemeta.setDisplayName(Command.st + ChatColor.RED + "상대방의 차례 입니다.");
                                        List stonelore = new ArrayList();
                                        stonelore.add(" ");
                                        stonelore.add(ChatColor.DARK_GRAY + " -  " + ChatColor.WHITE + "상대방의 현재 베팅액 " + ChatColor.GRAY + ": " + ChatColor.GOLD + Hashmap.getbetmoney(p) + "원");
                                        stonelore.add(" ");
                                        stonemeta.setLore(stonelore);
                                        redstone.setItemMeta(stonemeta);
                                        ItemStack betbtn = new ItemStack(Material.WOOD_BUTTON);
                                        ItemMeta betmeta = betbtn.getItemMeta();
                                        betmeta.setDisplayName(Command.st + ChatColor.RED + "베팅(Bet)");
                                        List betlore = new ArrayList();
                                        betlore.add(" ");
                                        betlore.add(ChatColor.DARK_GRAY + " -  " + ChatColor.RED + "현재 당신의 베팅액 " + ChatColor.GRAY + ": " + ChatColor.GOLD + Hashmap.getbetmoney(target) + "원");
                                        betlore.add(ChatColor.DARK_GRAY + " -  " + ChatColor.AQUA + "현재 상대의 베팅액 " + ChatColor.GRAY + ": " + ChatColor.GOLD + Hashmap.getbetmoney(p) + "원");
                                        betlore.add(" ");
                                        betmeta.setLore(betlore);
                                        betbtn.setItemMeta(betmeta);
                                        p.getOpenInventory().setItem(29, stack);
                                        target.getOpenInventory().setItem(13, redstone);
                                        target.getOpenInventory().setItem(29, betbtn);
                                        p.sendMessage(Command.st + ChatColor.RED + "더이상 베팅 할 수 없습니다. 베팅을 종료해주세요");
                                        p.playSound(p.getLocation(), Sound.BLOCK_NOTE_BELL, 1.0f, 1.0f);
                                    }

                                    else{
                                        Main.instance.econ.withdrawPlayer(p,(int)((double)(Hashmap.indiannmax.get(p.getUniqueId().toString())/10)));
                                        Hashmap.slotuse.put(p, Hashmap.getbetmoney(p) + (int)((double)Hashmap.indiannmax.get(p.getUniqueId().toString()) / 10));
                                        ItemStack stack = new ItemStack(Material.WOOD_BUTTON);
                                        ItemMeta meta = stack.getItemMeta();
                                        meta.setDisplayName(Command.st + ChatColor.RED + "베팅(Bet)");
                                        List lore = new ArrayList();
                                    ...
                                    target = Bukkit.getPlayer(UUID.fromString(Hashmap.getrequester(p.getUniqueId().toString())));
                                    if (Hashmap.getbetmoney(p) + (int)((double)Hashmap.indiannmax.get(target.getUniqueId().toString())/10) >= Hashmap.indiannmax.get(target.getUniqueId().toString())){
                                        Main.instance.econ.withdrawPlayer(p,Hashmap.indiannmax.get(target.getUniqueId().toString()) - Hashmap.getbetmoney(p));
                                        Hashmap.slotuse.put(p, Hashmap.getbetmoney(p) + Hashmap.indiannmax.get(target.getUniqueId().toString()) - Hashmap.getbetmoney(p));
                                        ItemStack stack = new ItemStack(Material.WOOD_BUTTON);
                                        ItemMeta meta = stack.getItemMeta();
                                        meta.setDisplayName(Command.st + ChatColor.RED + "베팅(Bet)");
                                        List lore = new ArrayList();
                                        ...
                                        lore.add(ChatColor.DARK_GRAY + " -  " + ChatColor.RED + "현재 당신의 베팅액 " + ChatColor.GRAY + ": " + ChatColor.GOLD + Hashmap.getbetmoney(p) + "원");
                                        lore.add(ChatColor.DARK_GRAY + " -  " + ChatColor.AQUA + "현재 상대의 베팅액 " + ChatColor.GRAY + ": " + ChatColor.GOLD + Hashmap.getbetmoney(target) + "원");
                                        lore.add(ChatColor.DARK_GRAY + " -  " + ChatColor.RED + "좌클릭시 " + ChatColor.GOLD + (int)((double)Hashmap.indiannmax.get(target.getUniqueId().toString())/10) +  ChatColor.WHITE + "원을 베팅합니다.");
                                        lore.add(ChatColor.DARK_GRAY + " -  " + ChatColor.GREEN + "우클릭시 베팅을 종료합니다. 단 상대방의 베팅액보다 크거나 같아야 합니다.");
                                        lore.add(" ");
                                        meta.setLore(lore);
                                        stack.setItemMeta(meta);
                                        ...
                                        Main.instance.econ.withdrawPlayer(p,(int)((double)(Hashmap.indiannmax.get(target.getUniqueId().toString())/10)));
                                        Hashmap.slotuse.put(p, Hashmap.getbetmoney(p) + (int)((double)Hashmap.indiannmax.get(target.getUniqueId().toString()) / 10));
                                        ItemStack stack = new ItemStack(Material.WOOD_BUTTON);
                                        ItemMeta meta = stack.getItemMeta();
                                        meta.setDisplayName(Command.st + ChatColor.RED + "베팅(Bet)");
                                        List lore = new ArrayList();
                                                ...
                                                public void run() {
                                                    if (p.getOpenInventory().getTitle().contains("인디언포커")) {
                                                        if (Integer.parseInt(finalPdeck) > Integer.parseInt(finalTargetdeck)) {
                                                            ...
                                                            Main.instance.econ.depositPlayer(p, Hashmap.getbetmoney(p) + Hashmap.getbetmoney(target));
                                                            ...
                                                            Main.instance.econ.depositPlayer(target, Hashmap.getbetmoney(target));
                                                            ...
                                                            target.playSound(target.getLocation(), Sound.ENTITY_CHICKEN_EGG, 3.0f, 1.0f);
                                                            Main.instance.econ.depositPlayer(target, Hashmap.getbetmoney(p) + Hashmap.getbetmoney(target));
