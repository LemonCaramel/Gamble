...
public class Hashmap {
    ...
    public static HashMap<Player, Integer> slotuse = new HashMap<>();
    public static HashMap<Player, List<String>> blackcard = new HashMap<>();
    ...
    public static void getcard(Player p){
        if (blackcard.get(p) == null){
            ArrayList<String> cards = new ArrayList<>(Arrays.asList(card.split(",")));
    ...
    public static List<String> returncards(Player p){
        if (blackcard.get(p) != null){
            return blackcard.get(p);
        }
        return null;
    }
    public static void setcard(Player p, List<String> list){
